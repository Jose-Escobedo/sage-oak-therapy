...
export default function AppointmentForm({contact}) {
  ...
  return (
    <section className="w-full bg-[#b1876e] py-16 md:py-24 px-6 text-white">
  ...
  <p className="text-sm text-gray-200 mt-2 italic">
    Please do not include personal health information in your message. This form is not HIPAA-compliant.
      ...
      {successMessage && (
        <div
          className="max-w-3xl mx-auto mb-6 text-center text-forest font-semibold transition-opacity duration-500 opacity-100 animate-fade-in"
        >
          {successMessage}
        </div>
      )}
      ...
      >
        ...
        <div className="text-center">
          <button
            ...
            className={`cursor-pointer bg-forest-dark hover-bg-oak text-white font-semibold py-3 px-8 rounded shadow-md transition flex items-center justify-center ${

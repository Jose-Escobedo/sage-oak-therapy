...
export default function BlogPost({ params }) {
  ...
  return (
    <>
      <section className="max-w-6xl mx-auto mt-40 px-6 py-16 text-gray-900 grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <aside className="lg:col-span-1">
          ...
          <div className="bg-forest-dark rounded-lg shadow-md py-6 px-6 text-center flex flex-col items-center">
